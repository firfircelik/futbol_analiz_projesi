...
FOOTBALL_DATA_MATCHES_JSON_PATH = os.path.join(RAW_DATA_DIR, 'football_data_matches.json')
FOOTBALL_DATA_API_URL = 'https://api.football-data.org/v4/competitions/BL1/matches'
...
def collect_football_data():
    try:
        ...
        with open(FOOTBALL_DATA_MATCHES_JSON_PATH, 'w') as f:
